...
#[ApiResource(
    operations: [
        new GetCollection(
        normalizationContext: ['groups' => ['parada:list', 'tour:mini']]
        ),
        new Get(
        normalizationContext: ['groups' => ['parada:item', 'tour:mini']]
        )
    ]
)]
...
class Tour
{
    ...
    #[ORM\Column(type: Types::TEXT)]
    #[Groups(['parada:item'])]
    private ?string $descripcion_larga_fr = null;
    ...
    #[ORM\OneToMany(mappedBy: 'tour', targetEntity: Slider::class, cascade: ['remove'])]
    ...
    public function setTituloEs(?string $titulo_es): static
    {
    ...
    public function getDescripcionLargaFr(): ?string
    {
        return $this->descripcion_larga_fr;
    }

    public function setDescripcionLargaFr(string $descripcion_larga_fr): static
    {
        $this->descripcion_larga_fr = $descripcion_larga_fr;
    ...
    public function getDescripcionLargaEs(): ?string
    {
        return $this->descripcion_larga_es;
    }

    public function setDescripcionLargaEs(string $descripcion_larga_es): static
    {
        $this->descripcion_larga_es = $descripcion_larga_es;
        return $this;
    }
    ...
    public function setRango(?\DateTimeInterface $hora_inicio, ?\DateTimeInterface $hora_fin): static
    {
    ...
    public function addParada(Parada $parada): self
    {
    ...
    public function removeParada(Parada $parada): self
    {
        if ($this->paradas->removeElement($parada)) {
            // set the owning side to null (unless already changed)
            if ($parada->getTour() === $this) {
                $parada->setTour(null);
            }
        }
